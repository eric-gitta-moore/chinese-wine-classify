...
# 训练函数
def train_model(model, X_train, y_train, X_val, y_val, criterion, optimizer, scheduler, num_epochs=2000, use_early_stopping=False):
    train_losses = []
    val_losses = []
...
def main():
    ...
    for fold, (train_idx, test_idx) in enumerate(kf.split(X)):
        ...
        train_losses, val_losses = train_model(
            model, X_train, y_train, X_test, y_test, criterion, optimizer, scheduler,
